...
<div class="card h-100 product-card">
    ...
    {{-- Relative wrapper: badges anchor here, NOT inside .ratio,
         otherwise Bootstrap's `.ratio > *` stretches them to full size. --}}
    <div class="position-relative">
        <a href="{{ route('product.show', $product) }}" class="d-block text-decoration-none">
